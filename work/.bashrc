...
# Sensitive stuff that I don't want on GitHub
. ~/.bash_sensitive
...
# Custom prompt with Git prompt and colouring
PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]:\[\033[30m\]\[\033[42m\]$(__git_ps1)\[\033[0m\]\$ '
